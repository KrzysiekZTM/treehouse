...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(!isset($error_message) && $_POST['addres'] != ""){
    ...
    if(!isset($error_message)){
		...
		$mail->Username = "krzysiek.zostawtonam@gmail.com";
		//Password to use for SMTP authentication
		$mail->Password = "fiiklxvttrmicojy";

	    $mail->CharSet = 'utf-8';
	    //It's important not to use the submitter's address as the from address as it's forgery,
	    //which will cause your messages to fail SPF checks.
	    //Use an address in your own domain as the from address, put the submitter's address in a reply-to
	    $mail->setFrom('krzysiek.zostawtonam@gmail.com', $name);
	    $mail->addReplyTo($email, $name);
	    $mail->addAddress('krzysiek.zostawtonam@gmail.com', 'Krzysztof Jabłoński');
		...
		<form action="suggest.php" method="post">
			<table>
				<tr>
					...
					<td><input id="name" type="text" name="name" value="<?php if(isset($name)){echo htmlspecialchars($name);} ?>" /></td>
				</tr>
				<tr>
					<th><label for="email">Email (required)</label></th>
					<td><input id="email" type="text" name="email" value="<?php if(isset($email)){echo htmlspecialchars($email);} ?>"/></td>
				</tr>
				<tr>
					...
					<td><select name="category" id="category" >
						...
						<option value="Movie" <?php if(isset($category) && $category == 'Movie'){echo " selected";} ?>>Movies</option>
				...
				<tr>
					...
					<td><input id="title" type="text" name="title" value="<?php if(isset($title)){echo htmlspecialchars($title);} ?>"/></td>
				</tr>
				<tr>
                <th>
            ...
            <tr>
                ...
                <tr>
					...
					<td><input id="year" type="text" name="year" value="<?php if(isset($year)){echo htmlspecialchars($year);} ?>"/></td>
				</tr>
				<tr>
				...
				<tr style="display: none;">
					<th><label for="addres">Addres</label></th>
					<td><p>please leave this field blank.</p><input type="text" id="addres" name="addres"></td>
				</tr>
			</table>
